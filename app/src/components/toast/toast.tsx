...
import ToastErrorIcon from '@/assets/svgs/toast-error.svg';
import ToastInfoIcon from '@/assets/svgs/toast-info.svg';
import ToastSuccessIcon from '@/assets/svgs/toast-success.svg';
