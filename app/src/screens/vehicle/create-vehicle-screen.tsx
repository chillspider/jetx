...
import { useCreateVehicle } from '@/core/hooks/useVehicles';
...
const CreateVehicleScreen: React.FC = () => {
	...
	const navigation = useNavigation<AppNavigationProp<'CreateVehicle'>>();

	const { refetch, vehicles } = useVehicleContext();
